# Generated by Django 4.0.3 on 2022-04-29 07:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ticket', models.CharField(choices=[('Area A ($100)', 'Area A ($100)'), ('Area B ($75)', 'Area B ($75)'), ('Area C ($50)', 'Area C ($50)')], max_length=20)),
